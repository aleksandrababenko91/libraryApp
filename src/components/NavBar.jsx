      ...
      <div id="carouselExampleIndicators" className="carousel slide">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src=".//images/image1.jpeg" className="d-block w-100" alt="Slide 1" />
          </div>
          <div className="carousel-item">
            <img src=".//images/image2.jpg" className="d-block w-100" alt="Slide 2" />
          </div>
          <div className="carousel-item">
            <img src=".//images/image3.jpg" className="d-block w-100" alt="Slide 3" />
          </div>
        </div>
